...
export interface EntryCardUnifiedProps {
  entry: {
    id: string;
    title?: string;
    tags?: string[];
...
const EntryCardUnified: React.FC<EntryCardUnifiedProps> = ({
  entry,
  onEdit,
  onDelete,
  onClick,
  ...
  return (
    ...
    >
      ...
      {(onEdit || onDelete) && (
        <div
          className="entry-actions-unified"
          style={{
            position: 'absolute',
            top: '14px',
            right: '14px',
      ...
      <style>{`
        .entry-card-unified:hover .entry-actions-unified {
          opacity: 1 !important;
...
export default EntryCardUnified;
